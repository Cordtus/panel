...
class WCClient {
    ...
    get redirectHrefWithWCUri() {
        ...
        if (this.nativeUrl) {
            href = (this.walletInfo.walletconnect.formatNativeUrl ||
                utils_2.CoreUtil.formatNativeUrl)(this.nativeUrl, this.qrUrl.data, this.env?.os, this.walletName);
        }
        else if (this.universalUrl) {
            href = (this.walletInfo.walletconnect.formatUniversalUrl ||
                utils_2.CoreUtil.formatUniversalUrl)(this.universalUrl, this.qrUrl.data, this.walletName);
        }
        return href;
    }
    get displayQRCode() {
    ...
    openApp(withWCUri = true) {
        ...
        if (href) {
            ...
            utils_2.CoreUtil.openHref(href);
        }
        else {
    ...
    async signDirect(chainId, signer, signDoc, signOptions) {
        ...
        return {
            signed: {
                ...
                accountNumber: long_1.default.fromString(signed.accountNumber, false),
